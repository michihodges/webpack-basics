...
### Entry
Add the entry to the webpack.config.js file:
```js
module.exports = {
    entry: './src/client/index.js'
}
```
Add the following the src/client/index.js file:
```js
alert('I exist!')
```
Run webpack with `npm run build` and the result should be a dist folder containing a main.js file with the `alert('I exist!')` showing at the end:
```js
